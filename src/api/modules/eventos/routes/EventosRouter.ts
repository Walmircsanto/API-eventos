...
import containerEvent from "../../../containes/containerEvent";

const eventosRouter = Router(); // Route e uma função dentro da express logo não instancio ela como uma classe
const eventoController = containerEvent.resolve(EventoController); //obter a instancia do eventoController
